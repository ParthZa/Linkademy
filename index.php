<?php
    ...
    //******************if faculty is already logged in******************
        ...
        <div class="row justify-content-center g-4">
            ...
            <div class="col-12 col-sm-10 col-md-6 col-lg-5 col-xl-4">
                <div class="card shadow border-0 rounded-4 h-100">
                    ...
                    <div class="p-4">
                        <img src="./Assets/Student/StudentLoginOption.jpg" class="img-fluid" style="max-height:220px; object-fit:contain;">
                    </div>

                    <div class="card-body">
                        <h4 class="fw-semibold">Student Login</h4>
                        <a href="/DE-Project/Student/StudentCredential/Login.php" class="btn btn-primary w-100 mt-3 rounded-pill">Login as Student</a>
                    </div>
            ...
            <div class="col-12 col-sm-10 col-md-6 col-lg-5 col-xl-4">
                <div class="card shadow border-0 rounded-4 h-100">
                    ...
                    <div class="p-4">
                        <img src="./Assets/Faculty/FacultyLoginOption.jpg" class="img-fluid" style="max-height:220px; object-fit:contain;">
                    </div>

                    <div class="card-body">
                        <h4 class="fw-semibold">Faculty Login</h4>
                        <a href="/DE-Project/Faculty/FacultyCredential/Login.php" class="btn btn-success w-100 mt-3 rounded-pill">Login as Faculty</a>
                    </div>
