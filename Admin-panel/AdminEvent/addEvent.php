...
if (isset($_POST['add'])) {
    ...
    // ✅ Admin event auto-approved
    $query = "INSERT INTO eventpost 
    (event_name, event_place, event_details, event_datetime, event_organizer, event_form_link, status, role, posted_by)
    VALUES 
    ('$name','$place','$details','$datetime','$organizer','$link','approved','admin','admin')";
