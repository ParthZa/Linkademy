...
if (isset($_POST['add'])) {
    ...
    VALUES 
    ('$name','$place','$details','$datetime','$organizer','$link','pending','$faculty','faculty')";
        ...
        <div class="col-lg-6 col-md-8">
            ...
            <div class="card shadow border-0 rounded-4">
                ...
                <div class="card-header bg-success text-white text-center rounded-top-4 py-3">
                    <h4 class="mb-0">
                        <i class="bi bi-calendar-plus me-2"></i> Add Event (Faculty)
                    </h4>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form method="post">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label for="eventName">
                                <i class="bi bi-card-text me-1"></i> Event Name
                            </label>
                        </div>
                        ...
                        <!-- Details -->
                        <div class="form-floating mb-3">
                            <textarea name="details" class="form-control" id="details" placeholder="Details" style="height: 100px" required></textarea>
                            <label for="details">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label for="organizer">
                                <i class="bi bi-person me-1"></i> Organizer
                            </label>
                        </div>
                        ...
                        <div class="form-floating mb-4">
                            ...
                            <label for="link">
                                <i class="bi bi-link-45deg me-1"></i> Registration Link
                            </label>
                        </div>
