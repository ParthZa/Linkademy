    ...
    <div class="container py-5">
        ...
        <div class="card shadow border-0 rounded-4 p-4 mb-4">
            <h4 class="fw-bold mb-1">
                <i class="bi bi-clipboard-data me-2"></i> Attendance Dashboard
            </h4>
            <p class="text-muted mb-0">Upload and manage student attendance records</p>
        </div>
        ...
        <div class="card shadow border-0 rounded-4 mb-4">
            ...
            <div class="card-body">
                ...
                <form action="upload_attendance.php"
                    method="POST"
                    ...
                    <div class="col-12">
                        <button class="btn btn-success w-100 rounded-pill" name="upload">
        ...
        <div class="card shadow border-0 rounded-4 mb-4">
            ...
            <div class="card-header bg-dark text-white rounded-top-4">
                <i class="bi bi-funnel me-2"></i> View Attendance
            </div>
